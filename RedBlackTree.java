...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    private boolean insertHelper(Node<T> newNode, Node<T> subtree) {
        ...
        // store newNode within left subtree of subtree
            ...
            if(subtree.leftChild == null) { // left subtree empty, add here
                ...
                if(newNode != root && !newNode.isBlack)
                {
    ...
    /**
     * Ensures that nodes inserted into the tree properly follow the Red Black Tree properties.
     * If they don't the method fixes the mistake in the tree, creating a valid red black tree.
     * 
     * @param newNode - node inserted into tree
     */
    private void enforceRBTreePropertiesAfterInsert(Node<T> newNode)
    {
    	if(newNode.parent.isBlack || newNode.parent == root)
    	{
    		return;
    	}
    	...
    	{
    		Node<T> gPar = newNode.parent.parent;
    		Node<T> tempChild;
    		...
    		if(newNode.isLeftChild() && newNode.parent == gPar.leftChild &&
    				(gPar.leftChild == null || gPar.leftChild.isBlack))
    		{
    			rotate(newNode, newNode.parent);
    			tempChild = gPar.rightChild;
    			rotate(gPar.rightChild, gPar);
    			gPar.isBlack = false;
    			tempChild.isBlack = true;
    			return;
    			
    		}
    		
    		if(!newNode.isLeftChild() && newNode.parent.isLeftChild() &&
    				(gPar.rightChild == null || gPar.rightChild.isBlack)) {
    			rotate(newNode, newNode.parent);    			
    			tempChild = gPar.leftChild;
    			rotate(gPar.leftChild, gPar);
    			gPar.isBlack = false;
    			tempChild.isBlack = true;
    			return;
    		...
    		if(newNode.isLeftChild() && !gPar.rightChild.isBlack)
    		{
    			if(gPar.rightChild != null)
    			{
    				gPar.rightChild.isBlack = true;
    			}
    			if(gPar.leftChild != null)
    			{
    				gPar.leftChild.isBlack = true;
    			}
    			
    			gPar.isBlack = false;
    			if(gPar.parent != null && !gPar.parent.isBlack)
    			{
    				enforceRBTreePropertiesAfterInsert(gPar);
    			}
    			else
    			{
    				return;
    		...
    		if(!newNode.isLeftChild() && !gPar.leftChild.isBlack)
    		{
    			if(gPar.rightChild != null)
    			{
    				gPar.rightChild.isBlack = true;
    ...
    public void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
    	...
    	if(child.isLeftChild() || parent.leftChild == child)
    	{
    		if(!parent.equals(root) && !parent.isLeftChild())
    		{
    		...
    		else if(!parent.equals(root) && parent.isLeftChild())
    		{
    			Node<T> grandparent = parent.parent;
    	...
    	{
    		throw new IllegalArgumentException("ERROR: Not Child of parent node.");
    	}
